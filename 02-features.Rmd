...
- For more info, see
  [this chapter of Advanced R](https://adv-r.hadley.nz/fp.html).
...
- This means that during installation many R libraries need C/C++ compiler and external libraries, which can result in various errors.
- Debugging `Rcpp`-code requires one to utilize C/C++ debuggers. For more information one can look for example at [this blog post ](https://blog.davisvaughan.com/2019/04/05/debug-r-package-with-cpp/).[@VaughanRcppDebug]
