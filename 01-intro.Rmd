...
This course will often reference the excellent book [Advanced R by Hadley Wickham](https://adv-r.hadley.nz/)[@wickham2019advanced].
This book is released under Creative Commons licence
([CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/>`_))
and it is a great tool for learning about R programming.
